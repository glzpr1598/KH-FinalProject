...
<script>
	...
	$("#save").click(function(){
		...
		|| $("#editor").val() == "<br style='clear:both;'>"){
			...
			if($("#editor").val().length > 2000){
				...
				$("#writefrm").attr("action","./clubNoticeWrite?club_id="+<%=request.getParameter("club_id")%>+"&sort=notice&count="+count+param);
				$("#writefrm").submit();
			}
		}
	});
	...
	$("#cancel").click(function(){
		location.href="./clubNoticeList?club_id="+<%=request.getParameter("club_id") %>+"&sort=notice";
	});
</script>
</html>