...
<script>
	...
	$("#save").click(function(){
		...
		|| $("#editor").val() == "<br style='clear:both;'>"){
			...
			if($("#editor").val().length > 2000){
				...
				$("#writefrm").attr("action","./clubPhotoBbsUpdate?&club_id="+${info.club_id}+"&clubBbs_id="+${info.clubBbs_id}+param+"&count="+count);
				$("#writefrm").submit();
			}
		}
	});
	...
	$("#cancel").click(function(){
		location.href="./clubPhotoBbsDetail?club_id=${info.club_id}&clubBbs_id=${info.clubBbs_id}";
	});
</script>
</html>