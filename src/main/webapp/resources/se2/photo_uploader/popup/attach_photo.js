    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/controller/file_uploader_html5.do'; 	//upload URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
    	...
    	doucument.getElementById("file").files[0] = tempFile;
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/controller/file_uploader.do',	//샘플 URL입니다.
 			//'http://localhost:8080/web/imageUpload.gm'
